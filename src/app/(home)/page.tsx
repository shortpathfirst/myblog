  ...
  const content = [
    {
      ...
      description: <>
        <p> Data Visualization is presenting large data sets and metrics into charts,graphs or other graphic
    ...
    },
    {
      ...
      description: <>
        ...
        <div className={styles.imageList}>
          <img src="https://placehold.co/400" width={180} height={180} />
          <img src="https://placehold.co/400" width={180} height={180} />
          <img src="https://placehold.co/400" width={180} height={180} />
          <img src="https://placehold.co/400" width={180} height={180} />
        </div>
      ...
      <main className={styles.main}>
        {
          content.map((c, i) => (
            <Strip key={i}>
              <StripImage imageURL={c.imageURL}>{c.description}</StripImage>
...
const StripImage = ({ children, imageURL }: { children: ReactNode, imageURL: string }) => {
  return (
...
const StripDescription = ({ skills, projects }: { skills: any, projects: any }) => {
  return (
