...
![](/postimages/similarity/mixFolder.PNG)
...
<img src="/postimages/similarity/sort1.png" alt="sorting colors" width="400"/>
<img src="/postimages/similarity/sort2.png" alt="sorting colors" width="400"/>
<img src="/postimages/similarity/sort3.png" alt="sorting colors" width="800"/>
...
The dataset consists by a reduced amount of images, around **10,000 bracelet pattern images** are used but only **4500** are used in this example due to the fact that there are different images sizes providing too much diversity that would need more fine-tuning.
...
<img src="/postimages/similarity/tsne.png" alt="tsne" width="300"/>
...
<img src="/postimages/similarity/dbscan.png" alt="clustering" width="800"/>
...
![](/postimages/similarity/clustering.png)