...
- [Architecture approaches](#architecture-approaches)
    - [🌐 Remote Processing via Web Server](#-remote-processing-via-web-server)
    - [🤖 On-Device Inference with TFlite Model](#-on-device-inference-with-tflite-model)
- [Machine learning model](#machine-learning-model)
    - [🧠 Using Mediapipe](#-using-mediapipe)
    - [🧠 Using a Pretrained model](#-using-a-pretrained-model)
    - [🧠 Using a Pretrained model with custom data](#-using-a-pretrained-model-with-custom-data)
...
![](/myblog/postimages/esp32/hand-landmarks.png)
